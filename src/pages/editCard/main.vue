<template>
  <div class="pb50">
    ...
    <div class="bgfff pl16 pb10 mb10">
      ...
      <div class="disflex">
        <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/user/card_1.png"
             alt=""
             class="w50 h50 mr10 bradius5 borderbox"
             :class="card_style == 0 ? 'bblue' : 'bfff' "
             @click="card_style_change(0)">
        <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/user/card_2.png"
             alt=""
             class="w50 h50 mr10 bradius5 borderbox"
             :class="card_style == 1 ? 'bblue' : 'bfff' "
             @click="card_style_change(1)">
        <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/user/card_3.png"
             alt=""
             class="w50 h50 mr10 bradius5 borderbox"
             :class="card_style == 2 ? 'bblue' : 'bfff' "
             @click="card_style_change(2)">
        <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/user/card_4.png"
             alt=""
             class="w50 h50 mr10 bradius5 borderbox"
    ...
    <div class="bgfff pl16 pr17 lh49 fs16 c38 mb11">
      <div class="disflex jsbet "
           @click="chooseCompany">
        <label for="company"
               class="fbold marks pr15">企业</label>
      ...
      <div class="disflex jsbet align-cen"
           v-if="type != 'edit'">
        <label for="password"
               class="fbold marks pr15">密令</label>
        <input type="text"
               id="password"
               class="pha8 textr h49 w220"
               placeholder="联系该企业BOSS获取密令"
               v-model="card_msg.password">
      </div>

      <div class="disflex jsbet align-cen">
        <label for="post"
               class="fbold">职位</label>
        <input type="text"
               id="post"
    ...
    <div class="bgfff pl16 pr17 lh49 fs16 c38 mb11 info-form">
      ...
      <div class="disflex jsbet align-cen">
        <label for="username"
               class="fbold marks pr15">姓名</label>
        <input type="text"
               maxlength="6"
               id="username"
               class="pha8 textr h49"
      ...
      <div class="disflex jsbet align-cen">
        <label for="tel"
               class="fbold marks pr15">手机号</label>
        <input type="number"
               id="tel"
               class="pha8 textr h49"
               placeholder="手机号"
...
export default {
  ...
  data () {
    return {
      ...
      diff_time: 0,
      now_get_auth: false,//
      userlogo: 'https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/user/user_gray_circle.png',//头像
      intro: '', // 120
      card_style: 0,//名片样式
      changeing: false,
  ...
  methods: {
    ...
    getSelfCompany () {
      WXAJAX.POST({ ignore: true }, '', '/company/getCompanyId').then((data, code) => {
        if (code != 209) {
    ...
    getMyCard () {//获取名片信息
      wx.showLoading();
      WXAJAX.POST({ ignore: true }, '', '/businessCard/getUserCard').then((data) => {
        wx.hideLoading();
        if (data) {
    ...
    chooseCompany () {
      const { type, invite } = this.$root.$mp.query;
