<template>
    <div class="pb50">
        ...
        <div class="bgfff mt10 pl15 pt20 pb21 pr15 disflex jsbet pl45 posre addr" v-if="default_addr.addressId">
        ...
        <div v-if="lists">
            <div v-for="(v,k) in lists" :key="k"
                 class="bgfff mt10 pl15 pt20 pb21 pr15 disflex jsbet pl45 posre addr">
