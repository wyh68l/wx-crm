<template>
  <div>
    <div class="top_card fs12 mb15 shadow_gray pb28" v-if="type == 'plus'">
      <div class="pl34 pt25 cblue fs12"><span class="before_line_3">{{card_msg.company || '企业名称'}}</span></div>
      ...
      <div class="disflex jsbet pl25 pr27 pt33">
        <div class="disflex">
          ...
          <span @click.stop="makePhone"
                v-if="!hasCard" >
            <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/user/tel.png"
        ...
        <span v-else
              @click.stop="moreTap">
          <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/crm/edit_card.png" alt=""
                            class="w16 h16"  />
        </span>
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        card1_logo:'https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/user/card1_user.png'
      }
    },
    methods:{
      page_turn(url){
