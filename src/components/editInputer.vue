  ...
  <div class="fix_bottom bgfff edit_input trans2"
    ...
    <div class="im_bottom animated disflex align-cen pl15 pr15 pt5 pb5 bgfff borderbox"
      ...
      <div class="disflex ml10">
        <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/more.png"
             @click="more"
             class="icon" />
      </div>
    </div>
    ...
    <div v-if="isMore"
      ...
      <div @click="photo">
        <div style="border: 2upx solid #E8E8E8;border-radius:10rpx;width: 96rpx;height: 96rpx;"
          ...
          <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/photo.png"
      ...
      <div @click="shot"
        ...
        <div style="border: 2upx solid #E8E8E8;border-radius:10rpx;width: 96rpx;height: 96rpx;"
             class="disflex align-cen jscen">
          <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/camera.png"
               style="height: 60rpx; width: 60rpx;"
               mode="widthFix" />
        </div>
      ...
      <div @click="video">
        <div style="border: 2upx solid #E8E8E8;border-radius:10rpx;width: 96rpx;height: 96rpx;"
             class="disflex align-cen jscen">
          <img src="https://hq-one-stand.oss-cn-shenzhen.aliyuncs.com/yimai_photos/video.png"
               style="height: 60rpx; width: 60rpx;"
               mode="widthFix" />
        </div>
